...
$stmt->bind_param("sssssssssssssss", $college, $team_name, $name1, $reg_no1, $email_id1, $mobile_no1, $team_size, $name2, $reg_no2, $email_id2, $mobile_no2, $name3, $reg_no3, $email3, $mobile_no3);
$stmt->execute();
    echo "here";
}
echo "done";
